...
<!--
**Bah-ios/bah-ios** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
* 🔭 Currently working on: **Crowdsourced Disaster Response Platform (CDRP)**
* 🌱 Learning: **Advanced Backend Development & Networking (CCNA)**
* 💡 Interests: **Cybersecurity, Mobile Apps, APIs, System Design**
* 🎯 Goal: Becoming a **skilled Software Engineer & Security Specialist**
...
### 🚨 Crowdsourced Disaster Response Platform (CDRP)

* 📱 Mobile app using FlutterFlow & Firebase
* 🌐 Website with React & Node.js
* 📍 Real-time location-based disaster reporting

### 🔐 Salamati Cyber Soft

* 🛡️ Cybersecurity solutions startup
* 🔍 Focused on system protection & digital safety
